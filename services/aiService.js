...
exports.detectObjects = void 0;
const fetchRetry_1 = require("../src/utils/fetchRetry");
const getApiKey = (config) => config.apiKey || '';
const detectObjects = async (imageBase64, config) => {
    ...
    try {
        ...
        const response = await (0, fetchRetry_1.fetchRetry)(fullUrl, {
            method: 'POST',
            headers: {
