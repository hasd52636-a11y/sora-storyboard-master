...
import { StoryStage, FrameTimeInfo } from './storyStructureCalculator';

/**
 * Story stage descriptions for guidelines
 */
const STORY_STAGE_DESCRIPTIONS: Record<StoryStage, { en: string; zh: string }> = {
  [StoryStage.SETUP]: {
 ...
 */
const PROGRESSION_INDICATORS: Record<StoryStage, { en: string[]; zh: string[] }> = {
  [StoryStage.SETUP]: {
 ...
 */
export function enhanceVisualPrompt(
 ...
 */
export function generateStoryStructureGuideline(language: 'en' | 'zh' = 'en'): string {
  const isZh = language === 'zh';
 ...
 */
export function generateSceneProgressionGuideline(language: 'en' | 'zh' = 'en'): string {
  const isZh = language === 'zh';
 ...
 */
export function generateCompleteStoryGuidelines(language: 'en' | 'zh' = 'en'): string {
 ...
 */
export function enhanceCompletePrompt(
  originalPrompt: string,
  frameTimeInfo: FrameTimeInfo,
 ...
 */
export function validateNoRepetition(prompt: string): { valid: boolean; warnings: string[] } {
